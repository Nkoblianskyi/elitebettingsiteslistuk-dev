...
export function Footer() {
  return (
    <footer style={{ backgroundColor: "#0C1510", borderTop: "1px solid rgba(200,168,107,0.10)" }}>

      {/* Thin gold top rule */}
      <div style={{ height: 1, backgroundColor: "#C8A86B", opacity: 0.65 }} />
      ...
      <div className="mx-auto max-w-6xl px-6 md:px-10 lg:px-16" style={{ paddingTop: 72, paddingBottom: 64 }}>
        ...
        {/* ── Divider ── */}
        <div style={{ height: 1, backgroundColor: "rgba(200,168,107,0.07)", margin: "52px 0 36px" }} />
