...
const DIVIDER = "1px solid rgba(212,168,83,0.08)"
...
export function InfoSections() {
  return (
    ...
    >
      ...
      <div
        className="w-full"
        style={{ borderBottom: "1px solid rgba(212,168,83,0.08)", backgroundColor: "#161616" }}
      >
          ...
          <div className="lg:w-5/12">
            ...
            <blockquote>
              ...
              >
                Rigorous assessment.
                <br />
                <em style={{ color: "#D4A853" }}>Independent</em>
                <br />
                editorial.
              </p>
            </blockquote>
            <div style={{ width: "40px", height: "2px", backgroundColor: "#D4A853", marginTop: "28px", marginBottom: "20px" }} />
            <p
              style={{
