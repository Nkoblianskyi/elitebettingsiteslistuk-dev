...
const DIVIDER = "1px solid rgba(200,168,107,0.08)"

export function InfoSections() {
  return (
    <section
      className="w-full"
      style={{ borderTop: "1px solid rgba(200,168,107,0.1)" }}
    >
      {/* Pull-quote banner */}
      <div
        className="w-full"
        style={{ borderBottom: "1px solid rgba(200,168,107,0.08)", backgroundColor: "#111E18" }}
      >
          ...
          <div className="lg:w-5/12">
            ...
            <blockquote>
              ...
              >
                Rigorous assessment.
                <br />
                <em style={{ color: "#C8A86B" }}>Independent</em>
                <br />
                editorial.
              </p>
            </blockquote>
            <div style={{ width: "40px", height: "2px", backgroundColor: "#C8A86B", marginTop: "28px", marginBottom: "20px" }} />
            <p
              style={{
