...
export function TermsModal({ isOpen, onClose }: TermsModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Gold top rule */}
        <div style={{ height: 2, backgroundColor: "#C8A86B", flexShrink: 0 }} />
        ...
        <div style={{
          ...
          <button
            ...
            onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(200,168,107,0.55)" }}
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              You must be <strong style={{ color: "#FFFFFF" }}>18 years of age or older</strong> to use this site.
        ...
        <div style={{
          ...
          padding: "12px 28px",
          textAlign: "center",
          borderTop: "1px solid rgba(200,168,107,0.09)",
